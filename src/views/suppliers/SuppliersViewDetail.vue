      ...
      <div class="info-section">
        <div class="info-card">
          <div class="supplier-header">
            <div
              class="supplier-logo"
              :style="{ backgroundColor: getSupplierColor() }"
            >
              {{ getSupplierInitials() }}
            </div>
            <div class="supplier-main">
              ...
              <span v-if="supplier.actif" class="status-badge active"
                >Actif</span
              >
        ...
        <div class="stats-card">
          ...
          <div class="metrics-section">
            ...
            <div class="metric-item">
              ...
              <span class="metric-value">{{
                formatDate(supplier.date_creation)
              }}</span>
            </div>
            ...
            <div class="metric-item">
              ...
              <span class="metric-value">{{
                formatDate(supplier.date_modification)
              }}</span>
            </div>
          </div>
...
export default {
  ...
  setup() {
    ...
    const getContactInitials = () => {
      if (!supplier.value) return "";
      const firstInitial = supplier.value.contact_prenom
        ? supplier.value.contact_prenom[0]
        : "";
      const lastInitial = supplier.value.contact_nom
        ? supplier.value.contact_nom[0]
        : "";
