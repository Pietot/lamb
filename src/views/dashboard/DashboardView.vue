    ...
    <div class="kpi-section">
      <div class="kpi-card kpi-alert">
        ...
        <div class="kpi-content">
          <p class="kpi-label">Alertes de stock</p>
      ...
      <div class="kpi-card kpi-orders">
        ...
        <div class="kpi-content">
          <p class="kpi-label">Commandes en préparation</p>
      ...
      <div class="kpi-card kpi-delivery">
        ...
        <div class="kpi-content">
          <p class="kpi-label">Livraisons à réceptionner</p>
          ...
          <table class="data-table">
            ...
            <tbody>
              ...
              <tr v-if="recentOrders.length === 0">
                <td colspan="100%" class="empty-message">Aucune commande récente</td>
              </tr>
            </tbody>
          </table>
        </div>
            ...
            <table class="data-table">
              ...
              <tbody>
                ...
                <tr v-if="pendingDeliveries.length === 0">
                  <td colspan="100%" class="empty-message">Aucune livraison en attente</td>
                </tr>
              </tbody>
            </table>
          </div>
  ...
  export default {
    ...
    setup() {
      ...
      const fetchOrders = async () => {
        ...
        try {
          const response = await fetch(VITE_API_URL + "get_table?table=commande", {
            method: "GET",
            headers: {
      ...
      const fetchDeliveries = async () => {
        ...
        try {
          const response = await fetch(VITE_API_URL + "get_table?table=livraison", {
            method: "GET",
            headers: {
              "Content-Type": "application/x-www-form-urlencoded",
            },
      ...
      const stockAlerts = computed(() => {
        return articles.value.filter(article => article.quantite_stock <= article.seuil_alerte)
          .length;
      });
