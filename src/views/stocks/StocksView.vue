          ...
          <table class="stocks-table">
            ...
            <tbody>
              ...
              <tr v-if="paginatedArticles.length === 0">
                <td colspan="100%" class="empty-message">Aucun article trouvé</td>
              </tr>
            </tbody>
          </table>
        </div>
            ...
            <div class="form-grid">
              ...
              <div class="form-group">
                <label for="quantite" class="form-label"
                  >Quantité initiale<span class="required-indicator">*</span></label
                >
                <input
              ...
              <div class="form-group">
                ...
                <input
                  ...
                  required
                />
                <span v-if="formErrors.reference_fournisseur" class="error-text">{{
          ...
          <div class="details-grid">
            ...
            <div class="details-section">
              ...
              <div class="detail-row">
                ...
                <span class="detail-value">
                  <span
                    v-if="selectedArticle.quantite_stock <= selectedArticle.seuil_alerte"
                    class="status-badge status-critical"
                  >
                    Stock critique
                  </span>
                  <span v-else class="status-badge status-ok"> Stock normal </span>
                </span>
              </div>
            </div>
            ...
            <div class="details-section full-width">
              ...
              <div class="detail-row">
                ...
                <span class="detail-value">{{
                  formatCurrency(selectedArticle.prix_achat * selectedArticle.quantite_stock)
                }}</span>
              </div>
              <div class="detail-row">
  ...
  export default {
    ...
    setup() {
      ...
      const lowStockCount = computed(() => {
        return filteredArticles.value.filter(item => item.quantite_stock <= item.seuil_alerte)
          .length;
      });
      ...
      const submitNewArticle = async () => {
        ...
        try {
          const response = await fetch(VITE_API_URL + "new_article", {
            method: "POST",
            body: formData,
            credentials: "include",
          });
