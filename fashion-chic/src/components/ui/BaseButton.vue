  ...
  computed: {
    buttonClasses() {
      ...
      const variantClasses = {
        primary: 'bg-turquoise text-white hover:bg-opacity-90 focus:ring-turquoise shadow-md hover:shadow-lg',
        secondary: 'border border-turquoise text-turquoise hover:bg-turquoise hover:text-white focus:ring-turquoise',
