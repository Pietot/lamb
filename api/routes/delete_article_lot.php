...
try {
    ...
    echo json_encode(['success' => true, 'message' => 'Article lot supprimé avec succès'], JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
} catch (Exception $e) {
